...
public class Int101Homework01 {
   ...
   static void work03UseOfUtilityClass() {
      ...
      */
        System.out.println(MyUtil.calculateBMI(50, 170));
        System.out.println(MyUtil.average(2, 4, 7));
   }
   ...
   static void work04UseOfObjectClass() {
      ...
      */
        ...
        BankAccount account1 = new BankAccount(101 , owner1);
        BankAccount account2 = new BankAccount(102, owner2);
