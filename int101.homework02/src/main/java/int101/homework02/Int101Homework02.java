...
public class Int101Homework02 {
    ...
    static void work01Utilitor() {
        ...
        System.out.println("Test Positive: " + Utilitor.testPositive(48.0));

        System.out.println("Check 562314789 : " + Utilitor.computeIsbn10(963_541_728) + '\n');
    ...
    static void work02Person() {
        ...
        Person person1 = new Person("Chanachon", "Wong");
        System.out.println(person1);
        Person person2 = new Person("Bung", "Roid");
        ...
        System.out.println(person2);
        person2.setFirstname("Sir");
        person2.setLastname("Dior");
        System.out.println(person2 + "" + '\n');
    ...
    static void work03Account() {
         ...
         * and check their correctness.
         */
        Person person1 = new Person("Louis", "Vong");
        Person person2 = new Person("Mike", "Jensen");
        ...
        System.out.println(account1.deposit(4800.00));
        System.out.println(account1.getBalance());
        System.out.println(account2.deposit(8400.00));
        System.out.println(account2.getBalance() + "" + '\n');

        System.out.println(account1.withdraw(2000.00));
        System.out.println(account1.getBalance());
        System.out.println(account2.withdraw(1700.00));
        System.out.println(account2.getBalance() + "" + '\n');

        System.out.println("Before transfer " + "Account 1 :" + account1.getBalance()
                + " , Account 2 : " + account2.getBalance());
        account1.transfer(9000.00, account2);
